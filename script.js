...
function injectUserBadge() {
  ...
  badge.innerHTML = `
    ...
    <div class="user-dropdown">
      ...
      <div class="ud-item" onclick="smoothScrollTo('#rooms')"><span class="ud-icon">🛏️</span> Browse Rooms</div>
      <div class="ud-item" onclick="smoothScrollTo('#hotels')"><span class="ud-icon">🏨</span> All Hotels</div>
      <div class="ud-divider"></div>
